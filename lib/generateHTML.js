    ...
    switch(role){
        case "Manager":
            ...
            <div class="card-body">
              ...
              <p><span style="font-weight:bold">Office Number:</span> ${data.officeNumber}</p>
        ...
        case "Engineer":
            ...
            <div class="card-body">
              ...
              <a href="https://github.com/${data.getGithub()}" class="card-link">${data.getGithub()}</a>
            </div>
        </div>`
        break;
        ...
        case "Intern":
            ...
            <div class="card-body">
              ...
              <p><span style="font-weight:bold">School:</span>${data.getSchool()}</p>
            </div>
        </div>`
        break;
